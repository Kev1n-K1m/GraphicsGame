...
##    wheel2LocZ = 0 
    ...
    def check_collision(self, ribbon):
        # Simple AABB collision detection
        if (self.posX > ribbon.x - ribbon.width / 2 and
            self.posX < ribbon.x + ribbon.width / 2 and
            self.posZ > ribbon.z - ribbon.length / 2 and
            self.posZ < ribbon.z + ribbon.length / 2):
